...
class SalesSelectProductsorderScreen extends StatefulWidget {
  ...
  const SalesSelectProductsorderScreen({super.key});

  @override
  State<SalesSelectProductsorderScreen> createState() =>
                    ...
                    Row(
                      children: [
                        for (int i = data.productDetail!.length - 1;
                            ...
                            i--)
                          Text(
                            '${data.productDetail![i].name}:     ', //${formatDivisionResult(products.result!.data![0].quandity!, qunatityData.result!.data![i].qty!, '')} ',
